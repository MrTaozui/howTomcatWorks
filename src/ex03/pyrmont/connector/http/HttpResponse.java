...
/**
 * 用来  根据http的请求 进行资源操作。   运行servlet 或者加载jsp , html 文件  并设置响应头
 * 如 cookies等
 * @author taojiajun
 *
 */
public class HttpResponse implements HttpServletResponse {
  ...
  /**
   * HTTP报头通过addHeader()显式地添加，但不包括使用setContentLength()、
   * setContentType()等添加的报头。该集合由头名称键控，元素是arraylist，其中包含已设置的相关值。
   */
  ...
  protected void sendHeaders() throws IOException {
    ...
    // Send all specified headers (if any) 发送所有指定的响应头
...
*/
    // Send all specified cookies (if any)    发送所有cookie
